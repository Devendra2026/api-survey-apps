...
export class ReportsRepository {
  ...
  async exportSurveys(user: AuthenticatedUser, filters: ExportFilters, take = 10000) {
    ...
    return this.prisma.db.survey.findMany({
      ...
      take,
      select: {
        id: true, propertyId: true, stateId: true, districtId: true, ulbId: true, wardId: true, localId: true, propertyIdOld: true, parcelNumber: true, unitSubNo: true, sectorNo: true,
        constructedYear: true, isSlum: true, wardNumber: true, respondentName: true, relationshipWithOwner: true,
        mobileNumber: true, alternateMobile: true, familySize: true, houseDoorNo: true, locality: true, colony: true, city: true,
        pinCode: true, assessmentYear: true, ownershipType: true, propertyUse: true, propertyType: true, situation: true, roadType: true,
        taxRateZone: true, plotAreaSqFt: true, plotAreaSqMeter: true, plinthAreaSqFt: true, plinthAreaSqMeter: true,
        totalBuiltAreaSqFt: true, totalBuiltAreaSqMeter: true, waterConnection: true, sourceOfWater: true, sanitationType: true,
        solidWasteCollection: true, electricityConsumerNo: true, latitude: true, longitude: true, gpsAccuracyMeters: true,
        capturedAt: true, gpsProvider: true, gpsMockLocation: true, qcStatus: true, serverVersion: true, clientUpdatedAt: true,
        surveyStatus: true,
        submittedAt: true,
        approvedAt: true,
        createdAt: true,
        ...
        floors: { select: { floorPosition: true, usageFactor: true, usageType: true, constructionType: true, occupancy: true, areaSqFt: true } },
